    ...
    return (
        <div>
            <div className="flex flex-col items-center gap-2 mt-4 mb-3 ">
                <h1 className="text-4xl text-center text-bgold-200 shimmer">
                    Timeline
                </h1>
            ...
            <div className="flex justify-center ">
                <div className="flex flex-col items-center gap-10 ">
                    <div className="sectionM  mt-4 w-[60vmin] text-bgold-200 md:h-60 h-24 md:px-8 md:py-4 px-4 py-2 border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                ...
                <button className="px-3 py-1 my-2 mt-3 duration-300 border rounded-lg md:px-6 md:py-3 bg-none hover:bg-Manga-100 hover:bg-opacity-10 text-bgold-200 border-bgold-200 md:text-xl">
                  Register
                    ...
                    <div className="sectionM   w-[60vmin]  text-bgold-200 md:h-60 h-30 md:px-8    md:py-4 px-4 py-2 border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            <span className="pb-3 text-sm text-bblue-200">
                                Registrations End
                            </span>
                    ...
                    <div className="sectionM   w-[60vmin]  text-bgold-200 md:h-60 h-30  md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                A short introductory session on GitHub and
                                Discord.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="sectionM   w-[60vmin]  text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                The inauguration of the 10th installation of the
                                CBIT Hacktoberfest Hackathon will be set
                                underway
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="sectionM   w-[60vmin] text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                Teams will be given until 6:45 PM to fill out
                                their choices
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="sectionM   w-[60vmin]  text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            <span className="pb-3 text-sm md:text-xl text-bblue-200">
                                Coding begins!
                            </span>
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                The contestants now set sail and begin their
                    ...
                    <div className="sectionM w-[60vmin]    text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                The time for the contestants to finish up has
                                finally come.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className=" sectionM w-[60vmin]   text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                Contestants must push their codes to GitHub
                                before the deadline and delays will not be
                                accepted
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="sectionM w-[60vmin]    text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                Pitching a solution to a panel of judges often
                                acts as the deciding factor to ensuring victory!
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="sectionM   w-[60vmin]  text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2    border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
                        ...
                        <div className="flex flex-col items-start ">
                            ...
                            <p className="hidden text-sm text-bgold-300 md:inline">
                                It’s time for closing remarks and to finally
                                announce the much awaited winners!
                            </p>
                        </div>
                    </div>
                </div>
